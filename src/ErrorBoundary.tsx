 ...
 *
 * A class, because that is the only form React offers for catching; it reaches
 * the translations through contextType instead of a hook. The provider sits
 * above this boundary, so it has necessarily rendered by the time we get here.
 */
    ...
    return (
      <div className="grid min-h-screen place-items-center bg-surface px-6 text-on-surface">
        <div className="w-full max-w-sm space-y-4 text-center">
          <h1 className="text-xl font-normal">{t('Quelque chose s’est mal passé')}</h1>
