...
const EN: Record<string, string> = {
  ...
  'vu il y a': 'seen',
  par: 'via',
  'la sortie directe': 'the direct way out',
  inactif: 'idle',
  'Aucune connexion ouverte en ce moment.': 'No connection open right now.',
  'Liste tronquée : trop de connexions ouvertes.': 'List truncated: too many connections open.',
